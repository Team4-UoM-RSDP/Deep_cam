    ...
    try:
        while True:
            ...
            for i in range(boxes.xyxy.shape[0]):
                ...
                candidates.append((depth, i))  # 保存 (深度, 索引)
            ...
            best_depth, best_i = candidates[0]
            ...
            print(
                f"[NEAREST] {pred_color} {shape_name} | "
                f"conf={conf:.2f} | depth={depth:.3f}m | X={X:.3f},Y={Y:.3f},Z={Z:.3f}"
            )
